<template>
  <div class="mx-auto w-157 relative">
    <div class="font-bold mt-10 text-[30px] text-center">TODO LIST</div>

    <div class="flex mt-4.5 w-full gap-4 justify-between">
      <div class="relative flex items-center grow">
        <input
          type="text"
          placeholder="Search Note..."
          class="h-full py-2 px-4 w-full rounded-[5px] border border-solid border-accent"
        />
        <div>
          <svg
      ...
      <select name="" id="" class="bg-[#6C63FF] rounded-[5px] p-4">
    ...
    <div class="flex mt-7.5 mx-28.75">
      <div class="flex">
        <input type="checkbox" />
        <div>11111</div>
      </div>
    ...
    <div class="absolute bottom-0 right-0 p-2 bg-[#6C63FF] text-2xl">+</div>
  </div>
</template>
