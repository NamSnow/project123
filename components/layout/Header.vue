<template>
  <div class="relative mx-auto h-auto w-full max-w-full">
    <div class="absolute inset-0 z-0">
      ...
      ></div>
      <div
        class="absolute inset-0 bg-[var(--color-primary)] opacity-80 z-10 w-full h-full"
      ></div>
    </div>
    ...
    >
      <div class="container mx-auto flex justify-between items-center py-5 p-5">
        ...
        <div class="flex">
          ...
          <button
            class="bg-[var(--color-accent)] w-9.5 h-9.5 rounded-lg cursor-pointer focus:bg-white lg:hidden text-white focus:text-black"
            @click="toggleMenu"
          >
